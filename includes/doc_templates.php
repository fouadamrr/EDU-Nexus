...
<style>
.gc-outer{border:6px solid #2c5f2e;padding:5px;font-family:'Cairo','Arial',sans-serif;direction:rtl;max-width:760px;margin:0 auto;background:#fffef8;}
...
.gc-hdr{display:flex;align-items:center;justify-content:space-between;border-bottom:2px solid #2c5f2e;padding-bottom:10px;margin-bottom:12px;}
...
.gc-ln{flex:1;border-bottom:1px solid #555;min-width:50px;}
...
<div class="gc-row"><span class="gc-lb">تاريخ موافقة مجلس الكلية :</span><span class="gc-ln"></span></div>
<div class="gc-row"><span class="gc-lb">تاريخ موافقة مجلس الجامعة :</span><span class="gc-ln"></span></div>
<div class="gc-row"><span class="gc-lb">وتحررت هذه الشهادة لتقديمها إلى :</span><span class="gc-ln"></span></div>
<div class="gc-row"><span class="gc-lb">رسوم البراءة — القسيمة رقم :</span><span class="gc-ln"></span><span class="gc-lb" style="min-width:65px;margin-right:6px;">بتاريخ :</span><span class="gc-ln"></span></div>
<div class="gc-row"><span class="gc-lb">رسوم الشهادة — القسيمة رقم :</span><span class="gc-ln"></span><span class="gc-lb" style="min-width:65px;margin-right:6px;">بتاريخ :</span><span class="gc-ln"></span></div>
