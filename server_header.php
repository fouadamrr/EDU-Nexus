...
$horizontal_tabs = [
 ...
 'financial' => ['title' => 'بيانات مالية', 'icon' => 'fa-money-bill-wave'],
...
$tab_sidebars = [
 ...
 ['link' => 'official_documents.php', 'icon' => 'fa-file-stamp', 'title' => 'الوثائق الرسمية', 'match' => 'official_documents'],
 ['link' => 'graduation_cert_review.php', 'icon' => 'fa-graduation-cap', 'title' => 'طلبات شهادة التخرج', 'match' => 'graduation_cert_review'],
 ],
 ],
 'programs' => [
 'المقررات الدراسية' => [
 ...
 'financial' => [
 'البوابة المالية' => [
 ['link' => 'http://edu-nexus.net/finance/', 'icon' => 'fa-landmark', 'title' => '💳 البوابة المالية',  'match' => '__finance_external__'],
 ]
 ],
 'absence' => [
 'الحضور والغياب' => [
...
if (in_array($role, ['super_admin', 'admin', 'dean', 'affairs', 'instructor'])) {
 ...
 $sidebar_sections['textbook_mgmt'] = [
  'title' => 'الكتب الدراسية',
  'icon'  => 'fa-book-open',
  'items' => [
  ['link' => 'textbook_payments.php', 'icon' => 'fa-list-check',    'title' => 'طلبات دفع الكتب', 'match' => 'textbook_payments'],
  ]
  ];
 }
 ...
 ['link' => '/finance/', 'icon' => 'fa-landmark', 'title' => '💳 البوابة المالية',  'match' => '__finance_external__'],
 ]
 ]
 ];
}
...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <link rel="shortcut icon" href="<?php echo $base_path; ?>assets/images/logo.png" type="image/x-icon">
...
<body class="flex h-screen overflow-hidden bg-bg">
 ...
 <span class="text-xs text-secondary opacity-80 font-medium">منظومة التعليم الآمن</span>
 </div>
 </a>
 <!-- Mobile Close -->
